...
function Programacion() {
  const colorMateria = "#D4E6F1";
  
  // Mi variable de control (como un boolean en Java)
    ...
    <>
      ...
      <main className="container mt-5">
        <div className="header-materia d-flex justify-content-between align-items-center mb-4">
          ...
          {/* El botón de + que cambia a - cuando está abierto */}
          <button 
        ...
        <div className="row justify-content-center">
          <div className="col-md-8 col-lg-6">
            ...
            {/* Si mostrarForm es true, renderizo el formulario */}
            {mostrarForm && (
